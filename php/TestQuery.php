...
$sql=[
    ...
    "INSERT INTO pilotplan.t_data_pilot (CHPILOTCODE, CHPILOTGRADE, CHPILOTCLASS, CHPILOTSTATE) VALUES ('260101', 'A', '1', '1');",
    ...
    "DELETE FROM pilotplan.t_data_pilot WHERE (CHPILOTCODE = '260101');"
];
db_OpenConn();
